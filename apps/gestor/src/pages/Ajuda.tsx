...
const TOPICOS: Topico[] = [
  ...
  },
  {
    ...
    descricao: 'Cadastre veículos, faça upload de fotos/vídeos, publique na Vitrine Pública, poste no Feed de Repasses e feche vendas.',
    ...
    passos: [
      ...
      { texto: 'Ative o toggle "Vitrine" para disponibilizar o veículo no portal público para compradores.', dica: 'Para ser publicado na Vitrine, o veículo deve ter status "Disponível" e pelo menos 1 foto.' },
      { texto: 'Ative o botão "Feed de Repasses" para ofertar o veículo diretamente para outras concessionárias parceiras na Rede Social.' },
  ...
  },
  {
    ...
    passos: [
      ...
      { texto: 'Clique em qualquer card para abrir os detalhes do lead: adicione histórico de interações (notas, ligações, WhatsApp, visitas) e simule propostas.', dica: 'Toda conversa iniciada por um cliente na Vitrine vira um Lead com origem "Vitrine" automaticamente no CRM.' },
    ],
  },
  {
    id: 'pos-venda',
  ...
  },
  {
    ...
    passos: [
      ...
      { texto: 'O Chat de Negociações permite mensagens instantâneas com outros lojistas.', dica: 'Quando chegam novas mensagens não lidas no Chat, um indicador numérico (badge) aparece no menu lateral.' },
    ],
  },
  {
    id: 'vitrine-b2c',
    titulo: 'Vitrine Pública & Site',
    ...
    passos: [
      { texto: 'A Vitrine Pública é o portal online de busca e descoberta de veículos para consumidores compradores.' },
      ...
      { texto: 'Quando o comprador clica em conversar com a loja na Vitrine, uma mensagem é iniciada e um **Lead com origem Vitrine** entra instantaneamente no CRM da sua loja.', dica: 'Dados internos da loja (preço de custo, margem de lucro, dados de repasse) jamais aparecem na Vitrine Pública.' },
    ],
  },
  {
    id: 'financeiro',
