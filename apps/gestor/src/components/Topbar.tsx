      ...
      <div className="topbar-actions">
        ...
        <div className="topbar-user-wrapper" ref={menuRef}>
          ...
          >
            ...
            <div className="topbar-user-avatar" style={{ overflow: 'hidden', padding: 0 }}>
              {user?.avatar_url ? (
                <img
                  src={user.avatar_url}
                  alt={user.nome}
          ...
          {menuAberto && (
            <div className="topbar-user-dropdown" role="menu">
              ...
              <button
                ...
                role="menuitem"
                onClick={() => { setMenuAberto(false); navigate('/configuracoes', { state: { aba: 'meu_perfil' } }) }}
              >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <button
                className="topbar-user-dropdown-item"
                role="menuitem"
                onClick={() => { setMenuAberto(false); navigate('/configuracoes', { state: { aba: 'perfil' } }) }}
              >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <button
                className="topbar-user-dropdown-item"
                role="menuitem"
                onClick={() => { setMenuAberto(false); abrirVitrineLogado() }}
              >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
