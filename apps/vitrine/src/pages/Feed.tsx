...
export function Feed() {
  ...
  return (
    <>
      ...
      {/* 10.6 Navegação mobile-first bottom navigation bar */}
      <div className="vt-mobile-nav" style={{
        ...
        <div onClick={() => navigate('/')} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', color: 'var(--vt-primary)', cursor: 'pointer', fontSize: 11 }}>
        ...
        <div onClick={() => navigate('/favoritos')} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', color: 'var(--vt-text-dim)', cursor: 'pointer', fontSize: 11 }}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ width: 20, height: 20, marginBottom: 2 }}>
            <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z" />
          </svg>
          <span>Favoritos</span>
        </div>
        <div onClick={() => navigate('/mensagens')} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', color: 'var(--vt-text-dim)', cursor: 'pointer', fontSize: 11 }}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ width: 20, height: 20, marginBottom: 2 }}>
